...
void draw_dithered_text(GContext *ctx, const char * text, GFont font, GRect bounds, GTextOverflowMode overflow_mode, GTextAlignment alignment, 
...
// background color: pass color of the background
// r, g, b - colors to mix
void draw_dithered_text_from_RGB(GContext *ctx, const char * text, GFont font, GRect bounds, GTextOverflowMode overflow_mode, GTextAlignment alignment, 
                                 GColor background_color, 
                                 int r, int g, int b){
  ...
  GColor first = getFirstGColorFromRGB(r, g, b);
	...
	draw_dithered_text(ctx, text, font, bounds, overflow_mode, alignment, background_color, first, second, recommended);
}
